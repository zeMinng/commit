...
title: "React Router"
date: "2026-03-11"
description: "React Router 安装、路由定义、导航跳转与嵌套路由"
tags:
  - React
---
...
## 小结
::: info 📖 相关资源
- [React Router](https://reactrouter.com/) - 包含 React Router 核心概念、API 详解及使用示例
- [react-router-dom](https://cn.redux.js.org/introduction/getting-started/) - 适用于 web 应用的 React Router 绑定库，提供路由组件及钩子函数
:::
